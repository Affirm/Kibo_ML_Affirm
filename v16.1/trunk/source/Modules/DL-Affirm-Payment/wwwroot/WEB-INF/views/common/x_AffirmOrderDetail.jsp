...
<%-- PayPal --%>
            <c:forEach var="payment" items="${payments}" >
              <div>
                <c:if test="${payment.description == 'PAYPAL'}">
                  ${payment.description}
                  <fmt:message key="msg.common.for" /> <mlamt:formatAmount value="${payment.amount}" />
                </c:if>
              </div>
...
<%-- Affirm --%>
            <c:forEach var="payment" items="${payments}" >
              <div>
                <c:if test="${payment.description == 'AFFIRM'}">
                  ${payment.description}
                  <fmt:message key="msg.common.for" /> <mlamt:formatAmount value="${payment.amount}" />
                </c:if>
              </div>
...
<caption class="ml-order-detail-sub-header"><fmt:message key="hdr.order.orderContents" /></caption>
...
<%-- Total Charge --%>
	<c:forEach var="payment" items="${payments}" >
		<c:if test="${payment.description == 'CREDIT CARD' or payment.description == 'PAYPAL'}">
