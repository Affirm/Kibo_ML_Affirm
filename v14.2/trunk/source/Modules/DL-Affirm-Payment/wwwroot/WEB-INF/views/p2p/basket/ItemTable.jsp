            ...
            <div class=sourcecodeBox>
                ...
                <div class="ml-basket-input-source">
                    <div class="ml-basket-input-wrapper">
                        <input class="form-control" type="text" name="sourceCode" id="sourceCode" class="couponCodeField" size="${site.FormFields.sourceCodeSize}" value="<c:out value="${basketForm.sourceCode}" />" maxlength="${site.FormFields.sourceCodeMaxLength}"/>
                    </div>
    ...
    <div class="ml-basket-column ml-basket-totals">
        ...
        <c:if test="${showSubTotal}">
            ...
            <div class="ml-basket-row ml-basket-subtotal">
                    ...
                    <div class="ml-basket-column ml-basket-total-value"><mlamt:formatAmount formatPriceData ="${formatPriceData}" value="${basketSubTotal}" /></div>
            </div>
        </c:if>
