...
public class  AffirmPaymentController extends PaymentController {
    ...
    private IPaymentServiceContext createServiceContext(HttpServletRequest request, CheckoutForm checkoutForm) {
        IPaymentServiceContext paymentServiceContext = new PaymentServiceContext();
        paymentServiceContext.setAttributeMap(checkoutForm.getAttributeMap());
        paymentServiceContext.setCommerceSession(WebUtil.getCommerceSession(request));
        return paymentServiceContext;
    }
