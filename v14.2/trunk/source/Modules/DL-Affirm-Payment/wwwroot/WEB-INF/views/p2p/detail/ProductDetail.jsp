						...
						<c:set var="addToBasket" value="/addToBasket.do"/>
							<div class="ml-product-btn-primary">
								<mlabtest:element uniqueIdentifier="detail_addToBasketButton" description="Add To Basket Button (Page Level)" uriSpecific="false">
									<input type="submit" name="addToBasket" class="ml-button-add-basket" onclick="document.getElementById('mainForm').action='${mlnav:pathRef(addToBasket, pageContext)}'" value='<fmt:message key="btn.altTxt.addToBasket" />'>
								</mlabtest:element>
							</div>
						</c:if>
							...
							<c:if test="${ProductDetailModel.wishListShown && ProductDetailModel.hasSkus}" >
								...
								<span class="ml-product-btn-wish-list">
									...
									<mlabtest:element uniqueIdentifier="detail_addToWishListButton" description="Add To WishList Button (Page Level)" uriSpecific="false">
										<button type="submit" name="addtoWishlist" class="ml-product-wish-list" onclick="document.getElementById('mainForm').action='${mlnav:pathRef(wishlistSelect, pageContext)}'"> <fmt:message key="btn.altTxt.addToWishlist"/></button>
									</mlabtest:element>
								</span>
							</c:if>
...
<div id="productData" style="display:none;" data-product-id="${ProductDetailModel.categoryItem.pk}" data-product-name="${ProductDetailModel.categoryItem.name}" />
