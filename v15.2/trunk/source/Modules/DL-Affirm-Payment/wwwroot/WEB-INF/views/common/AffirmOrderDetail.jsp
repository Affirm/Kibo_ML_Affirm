...
<%--  Credit Card --%>
            <c:forEach var="payment" items="${payments}" >
              <div>
                  <c:choose>
                      <c:when test="${payment.description == 'CREDIT CARD' || payment.description == 'CARD PRESENT'}">
                          ${payment.type}
...
<%-- Total Charge --%>
	<c:forEach var="payment" items="${payments}" >
		<c:if test="${payment.description == 'CREDIT CARD' or payment.description == 'PAYPAL' or payment.description == 'CASH'}">
