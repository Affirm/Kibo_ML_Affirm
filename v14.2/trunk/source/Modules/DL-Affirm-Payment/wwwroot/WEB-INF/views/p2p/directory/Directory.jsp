        ...
        <div class="ml-dir-header-category-wrapper ${classNoProducts}">
            <div class="ml-dir-header-category">
                <c:choose>
                    ...
                    <c:otherwise>
                        <c:set var="catHeader"><div class="ml-dir-header-category-head-image"><img src="${catalogImages.imagePath}${ProductDirectoryModel.catHeaderImage}" alt=""></div></c:set>
        ...
        <c:when test="${isProductsExist}">
            <div class="ml-grid-view">
                ...
                <div id="ml-grid-view-items" class="ml-grid-view-items ml-grid-view-multi-column">
                    ...
                    <c:forEach var="thumb" items="${ProductDirectoryModel.products}" >
